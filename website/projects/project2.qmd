...
The notebook guides you through 6 main questions:

1. **Pooling Strategies** (15 pts) — Compare methods for aggregating token representations
2. **PCA Implementation** (20 pts) — Build dimensionality reduction from scratch
3. **K-Means Clustering** (20 pts) — Discover emotion clusters unsupervised
4. **Natural Emotional Dimensions** (15 pts) — Analyze PCA results for emotions
5. **Supervised Safety Detection** (15 pts) — Train classifiers on neural activations
6. **Data Efficiency Curve** (15 pts) — Understand learning with limited labels
...
- [HuggingFace Transformers Docs](https://huggingface.co/docs/transformers/) — Model library documentation
...
- See [README.md](https://github.com/jinming99/learn-ml-by-building/blob/main/Project%202%20Neural%20Archaeology%20(instructor)/README.md) for detailed instructions

### Local Setup (Recommended if You Have GPU)
- Faster iteration
- More control over environment
- Requires: Python 3.8+, 8GB+ RAM, GPU recommended
